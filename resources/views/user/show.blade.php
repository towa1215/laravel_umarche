              ...
              <div class="p-6 bg-white border-b border-gray-200">
                  <div class="md:flex md:justify-around">
                    ...
                    <div class="md:w-1/2 ml-4">
                      <h2 class="md-4 text-sm title-font text-gray-500 tracking-widest">{{ $product->category->name }}</h2>
                      <h1 class="md-4 text-gray-900 text-3xl title-font font-medium">{{ $product->name }}</h1>
                      <p class="md-4 leading-relaxed">{{ $product->information }}</p>
